...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.rp-thumb{width:100%;height:0;padding-top:56.25%;position:relative;overflow:hidden;flex-shrink:0;background:#F5F0E9;}',
      '.rp-thumb img{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;transition:transform .4s;display:block;}',
      ...
      '@media(max-width:560px){',
        '.rp-wrap{padding:28px 16px 36px;}',
        '.rp-grid{grid-template-columns:1fr;gap:12px;}',
        '.rp-card{flex-direction:row;align-items:stretch;}',
        '.rp-thumb{width:120px;height:auto;padding-top:0;}',
        '.rp-body{padding:10px 12px;min-width:0;}',
        '.rp-title{font-size:.95em;margin-bottom:3px;}',
        '.rp-desc{font-size:.8em;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
      '}'
    ].join('');
